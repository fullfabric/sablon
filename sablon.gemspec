...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'docx tempalte processor'
  spec.description   = 'Sablon is a document template processor. At this time it works only with docx and MailMerge fields.'
